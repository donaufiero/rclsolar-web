<?php
	$title = "Our Solar Specialists | RCL Solar | New Jerseys Premier Solar Installer! Since 1999";
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Solar Specialists</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          echo'<div class="col-xs-12 col-sm-6 col-md-4">';
            echo'<div class="thumbnail thumbnail-3">';
              ...
              echo'<div class="caption">';
                echo'<h5>';
                  echo'<a href="'.$value['page'].'" class="text-sushi">'.htmlspecialchars($value['name']).'</a>';
                echo'</h5>';
