          ...
          <div class="row flow-offset-3">
            <div class="col-xs-12 col-sm-6 col-lg-3">
              <div class="rd-navbar-brand">
                <a href="index.html" class="brand-name">
                  <img src="images/Web_Logo_header.png" alt="">
                </a>
              </div>
			...
			<center>
                ...
                <dl class="dl-horizontal-mod-1">
                  <dt>Phone</dt>
                  <dd>
                    <a href="callto:#" class="text-primary"><?php echo $hqPhone; ?></a>
                  </dd>
                </dl>
                <dl class="dl-horizontal-mod-1">
                  <dt>Fax</dt>
                  <dd>
                    <a href="callto:#" class="text-primary"><?php echo $hqFax; ?></a>
                  </dd>
                </dl>
                <dl class="dl-horizontal-mod-1">
                  <dt>Email</dt>
                  <dd>
                    <a href="mailto:#" class="text-primary"><?php echo $hqEmail; ?></a>
                  </dd>
                </dl>
              </center>
			</div>
