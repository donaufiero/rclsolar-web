...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(empty($nameErr) && empty($emailErr) && empty($addErr) && empty($cityErr) ){
		...
		//$firstName = implode(" ",$parts);
			$comeBack = insertReferral($name, $lname, $email, $phone, $address, $city, 'NJ', $zip, $yname, $yphone, $yemail, $_SERVER['REMOTE_ADDR'],'');
			...
			if($comeBack == 'sucess'){
				...
				$email_to = 'cbell@rclsolar.com, nicole@rclsolar.com , marlyn@rclsolar.com'.$sEmail;
